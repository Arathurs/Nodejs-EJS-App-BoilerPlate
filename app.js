...
var start = require('./models/models.js').initialize();
mongoose.Promise = global.Promise;
var db = mongoose.connect('mongodb://localhost/name-of-database');
...
// log message to our console every time a request is made
